...
| `master.extraVolumes`                       | A list of volumes to be added to the Elasticsearch master pod(s)                                                                                                                                                                                               | `[]`                |
| `master.extraVolumeMounts`                  | A list of volume mounts to be added to the Elasticsearch master pod(s)                                                                                                                                                                                         | `[]`                |
...
| `data.extraVolumes`                          | A list of volumes to be added to the Elasticsearch data pod(s)                                                                                                                                                                                              | `[]`                |
| `data.extraVolumeMounts`                     | A list of volume mounts to be added to the Elasticsearch data pod(s)                                                                                                                                                                                        | `[]`                |
...
| `ingest.extraVolumes`                       | A list of volumes to be added to the Elasticsearch ingest pod(s)                                                                                                                                                                                              | `[]`                |
| `ingest.extraVolumeMounts`                  | A list of volume mounts to be added to the Elasticsearch ingest pod(s)                                                                                                                                                                                        | `[]`                |
